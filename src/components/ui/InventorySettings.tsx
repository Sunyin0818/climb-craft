    ...
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white/5 p-4 rounded-xl border border-white/5">
      ...
      <div className="flex items-center gap-4 sm:gap-6 justify-between flex-1">
        <div className="flex items-center gap-3">
          <span className="text-white/50 text-sm whitespace-nowrap">{t.inventorySettings.stockQuota}</span>
          <input 
        ...
        <div className="flex items-center gap-3">
          <span className="text-white/50 text-sm whitespace-nowrap min-w-[50px] sm:min-w-[70px] text-right">{t.inventorySettings.unitPrice} ({t.priceTag.currency}):</span>
          <input 
